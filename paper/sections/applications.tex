...
As a concrete example, rf-detr-nano running on a Jetson Orin with the TensorRT EP
achieves a median end-to-end latency of 57\,ms per frame at 640$\times$480 input
resolution, including HTTP overhead. The same model falls back gracefully to the CUDA EP
